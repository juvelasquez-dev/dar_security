...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .section-title-bar {
            width: 4px; height: 18px; background: var(--green-600);
        ...
        .chart-filter-select {
            font-size: 0.77rem; border-radius: var(--radius-sm);
        ...
        .arbo-table thead th {
            ...
            letter-spacing: 0.05em; text-transform: uppercase;
            padding: 0.75rem 1.1rem; border-bottom: 1px solid var(--green-200);
            white-space: nowrap;
        }
        ...
        .arbo-table td {
            padding: 0.8rem 1.1rem; vertical-align: middle; color: var(--text-main);
        }
        ...
        .revenue-bar {
            height: 6px; background: var(--gray-200); border-radius: 4px; overflow: hidden; margin-top: 3px;
        }
        ...
        .kpi-value {
            font-size: 1.55rem; font-weight: 700; color: var(--green-800); line-height: 1;
        }

        .kpi-sub { font-size: 0.72rem; color: var(--gray-400); }

        .kpi-bar-track {
            height: 5px; background: var(--gray-200); border-radius: 4px; overflow: hidden; margin-top: 4px;
        }
...
<header class="top-navbar">
    ...
    <span class="navbar-page-badge"><i class="bi bi-bar-chart-line me-1"></i> Sales Reports</span>
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0" style="min-width:280px;border-radius:12px;margin-top:8px;">
                ...
                <li>
                    <a class="dropdown-item py-2" href="#" style="font-size:.82rem;">
                        <i class="bi bi-cart-plus text-success me-2"></i> New order — #ORD-2024-048
                        <div class="text-muted" style="font-size:.72rem;padding-left:1.4rem;">Just now</div>
                    </a>
                </li>
                <li>
                    <a class="dropdown-item py-2" href="#" style="font-size:.82rem;">
                        <i class="bi bi-graph-up text-primary me-2"></i> Monthly sales target reached
    ...
    <div class="row g-4 mb-4">
            ...
            <div class="chart-card">
                <div class="chart-card-header">
                    <h6 class="chart-card-title">
                        <i class="bi bi-graph-up-arrow"></i> Sales Trend — Monthly Revenue
                    </h6>
        ...
        <div class="col-lg-4">
            <div class="chart-card h-100">
                <div class="chart-card-header">
                    <h6 class="chart-card-title">
                        <i class="bi bi-pie-chart-fill"></i> Order Status Breakdown
                    </h6>
                </div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-12">
            <div class="chart-card">
                <div class="chart-card-header">
                    <h6 class="chart-card-title">
                        <i class="bi bi-bar-chart-fill"></i> Orders Volume by Month
                    </h6>
            ...
            <div class="table-card">
                <div class="table-card-header">
                    <h6 class="table-card-title">
                        <i class="bi bi-trophy-fill"></i> Best Performing Products
                    </h6>
                        ...
                        <tbody>
                            @php
                                $topProducts = $topProducts ?? [
                                    ['name'=>'Premium White Rice','sku'=>'GRN-001','seller'=>'Juan dela Cruz','units'=>'280 kg','revenue'=>14560,'max_rev'=>14560],
                                    ['name'=>'Bangus Fry (Fingerlings)','sku'=>'FRM-001','seller'=>'Juan dela Cruz','units'=>'4,500 pcs','revenue'=>36000,'max_rev'=>14560],
                                    ['name'=>'Fresh Coconut (Whole)','sku'=>'FRT-001','seller'=>'Pedro Reyes','units'=>'320 pcs','revenue'=>11200,'max_rev'=>14560],
                                    ['name'=>'Native Chicken (Live)','sku'=>'LST-001','seller'=>'Luz Villanueva','units'=>'42 heads','revenue'=>15960,'max_rev'=>14560],
                                    ['name'=>'Processed Coconut Oil','sku'=>'PRC-001','seller'=>'Elena Torres','units'=>'58 pcs','revenue'=>12180,'max_rev'=>14560],
                                ];
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span style="font-size:.82rem;font-weight:600;color:var(--green-700);">{{ $product['units'] }}</span>
                                </td>
                                <td>
                                    <div class="revenue-bar-wrap">
                                        ...
                                        <div class="revenue-bar">
                                            <div class="revenue-bar-fill" style="width:{{ $maxRev > 0 ? round(($product['revenue'] / $maxRev) * 100) : 0 }}%;"></div>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <table class="arbo-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span style="font-weight:700;font-size:.88rem;color:var(--green-800);">₱{{ number_format($sale['amount']) }}</span>
                                </td>
                                <td class="text-center">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            ...
            <div class="chart-card">
                <div class="chart-card-header">
                    <h6 class="chart-card-title">
                        <i class="bi bi-tag-fill"></i> Revenue per Category
                    </h6>
                </div>
                <div class="p-4" style="height:220px;position:relative;">
                    ...
                    <div class="d-flex align-items-center gap-2 mb-2">
                        ...
                        <div style="flex:1;">
                            <div style="height:4px;background:var(--gray-200);border-radius:4px;overflow:hidden;">
                                <div style="height:100%;border-radius:4px;background:{{ $cb['color'] }};width:{{ $cb['pct'] }}%;"></div>
                            </div>
                        </div>
                ...
                <div class="px-3 py-2">
                    ...
                    <div class="py-2" style="{{ !$loop->last ? 'border-bottom:1px solid var(--gray-100)' : '' }};">
                        <div class="d-flex align-items-center gap-2 mb-1">
                            ...
                            <div style="flex:1;">
                                <div style="font-size:.82rem;font-weight:600;color:var(--green-800);">{{ $ts['name'] }}</div>
                            </div>
        ...
        new Chart(catCtx.getContext('2d'), {
            ...
            options: {
                ...
                plugins: {
                    legend: { display: false },
                    tooltip: {
                        callbacks: { label: ctx => ` ${ctx.raw}% of total revenue` }
                    }
                },
                scales: {
                    x: {
