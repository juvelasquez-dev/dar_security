...
<head>
    ...
    <title>ARBO Marketplace Dashboard — E-Agraryo Merkado</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .stock-high  .stock-bar-fill { background: var(--green-600); }
        .stock-med   .stock-bar-fill { background: var(--gold); }
        .stock-low   .stock-bar-fill { background: #dc3545; }
        ...
        .status-completed  .status-dot { background: #1a73e8; }
        .status-processing .status-dot { background: #0d8a7e; }
...
<body>
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0" style="min-width:280px; border-radius:12px; margin-top:8px;">
                    ...
                    <li>
                        <a class="dropdown-item py-2" href="#" style="font-size:.82rem;">
                            <i class="bi bi-cart-plus text-success me-2"></i> New order received
                            <div class="text-muted" style="font-size:.72rem; padding-left:1.4rem;">Just now</div>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item py-2" href="#" style="font-size:.82rem;">
                            <i class="bi bi-box-seam text-primary me-2"></i> Seller added product
                            <div class="text-muted" style="font-size:.72rem; padding-left:1.4rem;">1 hour ago</div>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item py-2" href="#" style="font-size:.82rem;">
                            <i class="bi bi-exclamation-triangle text-warning me-2"></i> Order #2048 pending
                            <div class="text-muted" style="font-size:.72rem; padding-left:1.4rem;">3 hours ago</div>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item py-2" href="#" style="font-size:.82rem;">
                            <i class="bi bi-person-plus text-info me-2"></i> New buyer registered
    ...
    <aside class="sidebar" id="mainSidebar">
        <div class="sidebar-inner">
            ...
            <a href="{{ url('/arbo/dashboard') }}" class="sidebar-link active">
            ...
            <a href="{{ url('/arbo/products') }}" class="sidebar-link">
                <i class="bi bi-box-seam"></i>
                Products
                <span class="sidebar-link-badge">{{ $totalProducts ?? '0' }}</span>
            </a>

            <a href="{{ url('/arbo/orders') }}" class="sidebar-link">
            ...
            <a href="{{ url('/arbo/reports') }}" class="sidebar-link">
            ...
            <a href="{{ url('/arbo/profile') }}" class="sidebar-link">
            ...
            <div class="col-6 col-xl-3">
                <div class="stat-card">
                    ...
                    <div>
                        ...
                        <span class="stat-trend up"><i class="bi bi-arrow-up-short"></i> +8 this month</span>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-3">
                <div class="col-6 col-md-3">
                    <a href="{{ url('/arbo/products/create') }}" class="quick-action-card">
                        ...
                        <div>
                            <p class="quick-action-label">Add Product</p>
                            <p class="quick-action-sub">List a new product</p>
                        </div>
                    </a>
                </div>
                <div class="col-6 col-md-3">
                    <a href="{{ url('/arbo/products') }}" class="quick-action-card">
                        ...
                        <div>
                            <p class="quick-action-label">Manage Products</p>
                            <p class="quick-action-sub">View & edit listings</p>
                        </div>
                    </a>
                </div>
                <div class="col-6 col-md-3">
            ...
            <div class="col-lg-4">
                ...
                <div class="table-card">
                    <div class="table-card-header">
                        ...
                        <a href="{{ url('/arbo/orders') }}" class="btn btn-sm" style="background: var(--green-100); color: var(--green-700); border:none; font-size:.78rem; border-radius:8px; font-weight:600;">
                            View All <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
                    <div>
                        <div class="order-item">
                            <div>
                                <div class="order-id">#2048</div>
                                <div class="order-meta">Rice · Buyer: Jose Ramos</div>
                            </div>
                            <div class="d-flex flex-column align-items-end gap-1">
                                <span class="status-badge status-pending"><span class="status-dot"></span> Pending</span>
                                <div class="order-amount">₱1,040<small>20 kg</small></div>
                            </div>
                        </div>
                        <div class="order-item">
                            <div>
                                <div class="order-id">#2047</div>
                                <div class="order-meta">Corn · Buyer: Ana Cruz</div>
                            </div>
                            <div class="d-flex flex-column align-items-end gap-1">
                                <span class="status-badge status-completed"><span class="status-dot"></span> Completed</span>
                                <div class="order-amount">₱560<small>20 kg</small></div>
                            </div>
                        </div>
                        <div class="order-item">
                            <div>
                                <div class="order-id">#2046</div>
                                <div class="order-meta">Coconut · Buyer: Mark Lim</div>
                            </div>
                            <div class="d-flex flex-column align-items-end gap-1">
                                <span class="status-badge status-processing"><span class="status-dot"></span> Processing</span>
                                <div class="order-amount">₱1,750<small>50 pcs</small></div>
                            </div>
                        </div>
                        <div class="order-item">
                            <div>
                                <div class="order-id">#2045</div>
                                <div class="order-meta">Vegetables · Buyer: Lea Santos</div>
                            </div>
                            <div class="d-flex flex-column align-items-end gap-1">
                                <span class="status-badge status-completed"><span class="status-dot"></span> Completed</span>
                                <div class="order-amount">₱360<small>3 bundles</small></div>
                            </div>
                        </div>
                        <div class="order-item">
                            <div>
                                <div class="order-id">#2044</div>
                                <div class="order-meta">Rice · Buyer: Ramon Garcia</div>
                            </div>
                            <div class="d-flex flex-column align-items-end gap-1">
                                <span class="status-badge status-pending"><span class="status-dot"></span> Pending</span>
                                <div class="order-amount">₱2,600<small>50 kg</small></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="table-card mb-4">
                    <ul class="activity-log">
                        ...
                        <li class="activity-item">
                            <div class="activity-dot-wrap">
                                <div class="activity-dot ad-green"><i class="bi bi-cart-check-fill"></i></div>
                            </div>
                            <div>
                                <div class="activity-title">Order #2047 completed</div>
                                <div class="activity-meta">Buyer: Ana Cruz · 1 hr ago</div>
                            </div>
                        </li>
                        <li class="activity-item">
                            <div class="activity-dot-wrap">
                        ...
                        <li class="activity-item">
                            <div class="activity-dot-wrap">
                                <div class="activity-dot ad-red"><i class="bi bi-exclamation-circle-fill"></i></div>
                            </div>
                            <div>
                ...
                <div class="chart-card">
                    ...
                    <div class="px-4 pb-3 d-flex flex-wrap gap-2 justify-content-center">
                        ...
                        <span class="status-badge status-pending">
                            <span class="status-dot"></span> Orders
                        </span>
                    </div>
                </div>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // ── Marketplace Activity Line Chart ───────────────────
            ...
            new Chart(actCtx.getContext('2d'), {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            label: 'Products',
                            data: [8, 14, 22, 30, 28, 38],
                            borderColor: 'rgba(26,115,232,1)',
                            backgroundColor: 'rgba(26,115,232,0.08)',
                            borderWidth: 2.5, tension: 0.38, fill: false,
                            pointBackgroundColor: '#fff', pointBorderColor: 'rgba(26,115,232,1)',
        ...
        if (ordCtx) {
            new Chart(ordCtx.getContext('2d'), {
                type: 'bar',
                data: {
                    labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'],
                    datasets: [{
