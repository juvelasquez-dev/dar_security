...
<head>
  ...
  <title>Finance — Orders | E-Agraryo Merkado</title>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .readonly-notice i { color: var(--gold); font-size: 1rem; flex-shrink: 0; }
    ...
    .tab-pill:not(.active) .tab-pill-count {
      background: var(--gray-100);
      color: var(--gray-600);
    }
    ...
    .search-input:focus { outline: none; border-color: var(--green-500); background: #fff; box-shadow: 0 0 0 3px rgba(31,128,60,0.08); }
    ...
    .fin-table tbody tr.order-row { cursor: pointer; }
    ...
    .timeline-event { font-size: 0.83rem; font-weight: 600; color: var(--text-main); }
    ...
    @media (max-width: 991.98px) {
      ...
      #orderDetailOffcanvas { width: 100% !important; }
    }
  ...
  <div class="table-card">
    <div class="table-card-header">
      <h6 class="table-card-title">
        ...
        Order List
        @if(isset($orders) && method_exists($orders, 'total') && $orders->total())
    ...
    <div class="table-responsive">
      <table class="fin-table">
        <thead>
          <tr>
            <th class="sortable" data-col="order_no">Order No <span class="sort-icon">↕</span></th>
            <th>Buyer (ARBO)</th>
            <th>Seller (ARBO)</th>
            <th>Products</th>
            ...
            <th>Order Status</th>
            <th>Delivery</th>
            <th class="sortable" data-col="created_at">Date <span class="sort-icon">↕</span></th>
            <th></th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr class="order-row"
            ...
            <td style="font-size:.83rem;">{{ $order->seller_arbo ?? '—' }}</td>
          ...
          <tr>
            <td colspan="10">
              <div class="empty-state">
                ...
                <a href="{{ route('finance.orders.index') }}" class="btn-card-action mt-3 d-inline-flex">
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="orderDetailOffcanvas" aria-labelledby="orderDetailLabel">
  <div class="offcanvas-header">
    <div>
      <h6 class="mb-0" id="orderDetailLabel"
  ...
  <div class="offcanvas-body p-0" style="overflow-y:auto;">
    ...
    <div class="detail-section">
      ...
      <div id="detailProducts" style="font-size:.83rem;color:var(--text-main);line-height:1.55;">—</div>
    </div>
    ...
    <div class="detail-section" id="detailNotesWrap" style="display:none;">
      ...
      <p id="detailNotes" style="font-size:.83rem;color:var(--text-main);margin:0;line-height:1.55;"></p>
    </div>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function openDetail(row) {
    ...
    // Timeline dot states
    document.getElementById('tlDotPayment').className  = 'timeline-dot' + (d.paymentStatus === 'paid' ? '' : ' pending');
    document.getElementById('tlDotDelivery').className = 'timeline-dot' + (d.delivery === 'delivered' ? '' : ' pending');
